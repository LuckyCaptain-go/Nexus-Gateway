...
func (d *MinIOIcebergDriver) ApplyBatchPagination(sql string, batchSize, offset int64) (string, error) {
	// For MinIO Iceberg files, pagination is typically not supported in the same way as traditional databases
