...
type DriverRegistry struct {
	drivers map[model.DatabaseType]func() Driver
	mutex   sync.RWMutex
}
...
func NewDriverRegistry() *DriverRegistry {
	registry := &DriverRegistry{
		drivers: make(map[model.DatabaseType]func() Driver),
	}
...
func (dr *DriverRegistry) registerDrivers() {
	...
	dr.register(model.DatabaseTypeMySQL, func() Driver {
		return NewMySQLDriver(model.DatabaseTypeMySQL)
	})
	dr.register(model.DatabaseTypeMariaDB, func() Driver {
		return NewMySQLDriver(model.DatabaseTypeMariaDB)
	})
	dr.register(model.DatabaseTypePostgreSQL, func() Driver {
		return NewPostgreSQLDriver(model.DatabaseTypePostgreSQL)
	})
	dr.register(model.DatabaseTypeOracle, func() Driver {
		return NewOracleDriver(model.DatabaseTypeOracle)
	})
...
func (dr *DriverRegistry) register(dbType model.DatabaseType, factory func() Driver) {
...
func (dr *DriverRegistry) GetDriverCategory(dbType model.DatabaseType) (DriverCategory, error) {
